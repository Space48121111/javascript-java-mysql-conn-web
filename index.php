...
if (isset($_POST['submit'])) {
  ...
  if (empty($nameErr) && empty($emailErr) && empty($bodyErr)) {
    // add to database
    $sql = "INSERT INTO testimony (name, email, body) VALUES ('$name', '$email', '$body')";
...
?>
    ...
    <p class="lead text-center">Leave your testimony</p>
    ...
    <form method="POST" action="<?php echo htmlspecialchars(
      ...
      <div class="mb-3">
        ...
        <div id="validationServerTestimony" class="invalid-testimony">
      ...
      <div class="mb-3">
        <label for="body" class="form-label">testimony</label>
        <textarea class="form-control <?php echo !$bodyErr ?:
          'is-invalid'; ?>" id="body" name="body" placeholder="Enter your testimony"><?php echo $body; ?></textarea>
      </div>
      <div class="mb-3">
